...
function copyAsset(outputDir, assetName) {
  ...
  var createDestDir = (0, _mkdirp2.default)(_path2.default.join(outputDir, 'assets', _path2.default.dirname(assetName)));
...
function renderHTMLReport(opt /* : Object */) /* : Promise<*> */{
  ...
  function sourceReportContent() {
    return new Promise(function (resolve, reject) {
      ...
      return (0, _mkdirp2.default)(_path2.default.join(opt.outputDir, 'sourcefiles', dirName)).then(function () {
  ...
  return waitForReportContent.then(function (res) {
    ...
    return (0, _mkdirp2.default)(_path2.default.dirname(reportFilePath)).then(function () {
